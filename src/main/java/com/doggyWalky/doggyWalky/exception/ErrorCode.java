...
public enum ErrorCode {
    ...
    INCORRECT_FORMAT_TITLE(HttpStatus.UNPROCESSABLE_ENTITY, "Title format is Incorrect"),
    INCORRECT_FORMAT_CONTENT(HttpStatus.UNPROCESSABLE_ENTITY, "Content format is Incorrect"),
